...
public class HotBar : MonoBehaviour
{
    ...
    private TextDict textDict;
    private GuiCoords guiCoordinates;
    ...
    public void Start()
    {
        ...
        guiCoordinates = new GuiCoords();
        slots = new Dictionary<int, string>();
        textDict = gameObject.AddComponent<TextDict>();
        ...
        if (ShowHotBar() == true)
        {
            ...
            foreach (Rect slotPos in slotRects)
            {
                ...
                if (slots.ContainsKey(slot))
                {
                    ...
                    if (textDict.dictionary.ContainsKey(itemInSlot + "_Icon"))
                    {
                        GUI.DrawTexture(slotTextureRect, textDict.dictionary[itemInSlot + "_Icon"]);
                    }
                    else if (textDict.dictionary.ContainsKey(itemInSlot))
                    {
                        GUI.DrawTexture(slotTextureRect, textDict.dictionary[itemInSlot]);
                    }
                }
